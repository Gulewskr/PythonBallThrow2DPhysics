...
class cząsteczka():
    ...
    def ruch(self):
        ...
        if len(self.polozenia_y) > 4:
            if self.polozenia_y[len(self.polozenia_y) - 3] < self.polozenia_y[len(self.polozenia_y) - 4] and self.polozenia_y[len(self.polozenia_y) - 1] > self.polozenia_y[len(self.polozenia_y) - 2]:
                self.kat = - self.kat
        ...
        print(str(self.czas_opadania) + " prev: " + str(self.prev_opadania))
